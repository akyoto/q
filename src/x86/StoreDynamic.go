...
func StoreDynamicNumber(code []byte, base cpu.Register, offset cpu.Register, scale Scale, length byte, number int) []byte {
...
func StoreDynamicRegister(code []byte, base cpu.Register, offset cpu.Register, scale Scale, length byte, source cpu.Register) []byte {
