...
func TestLoadDynamicRegisterZeroExtend(t *testing.T) {
	usagePatterns := []struct {
		...
		{x86.R15, 2, x86.R0, x86.R15, []byte{0x4E, 0x0F, 0xB7, 0x3C, 0x38}},
		{x86.R15, 1, x86.R0, x86.R15, []byte{0x4E, 0x0F, 0xB6, 0x3C, 0x38}},
		{x86.R14, 2, x86.R1, x86.R14, []byte{0x4E, 0x0F, 0xB7, 0x34, 0x31}},
		{x86.R14, 1, x86.R1, x86.R14, []byte{0x4E, 0x0F, 0xB6, 0x34, 0x31}},
		{x86.R13, 2, x86.R2, x86.R13, []byte{0x4E, 0x0F, 0xB7, 0x2C, 0x2A}},
		{x86.R13, 1, x86.R2, x86.R13, []byte{0x4E, 0x0F, 0xB6, 0x2C, 0x2A}},
		{x86.R12, 2, x86.R3, x86.R12, []byte{0x4E, 0x0F, 0xB7, 0x24, 0x23}},
		{x86.R12, 1, x86.R3, x86.R12, []byte{0x4E, 0x0F, 0xB6, 0x24, 0x23}},
		{x86.R11, 2, x86.SP, x86.R11, []byte{0x4E, 0x0F, 0xB7, 0x1C, 0x1C}},
		{x86.R11, 1, x86.SP, x86.R11, []byte{0x4E, 0x0F, 0xB6, 0x1C, 0x1C}},
		{x86.R10, 2, x86.R5, x86.R10, []byte{0x4E, 0x0F, 0xB7, 0x54, 0x15, 0x00}},
		{x86.R10, 1, x86.R5, x86.R10, []byte{0x4E, 0x0F, 0xB6, 0x54, 0x15, 0x00}},
		{x86.R9, 2, x86.R6, x86.R9, []byte{0x4E, 0x0F, 0xB7, 0x0C, 0x0E}},
		{x86.R9, 1, x86.R6, x86.R9, []byte{0x4E, 0x0F, 0xB6, 0x0C, 0x0E}},
		{x86.R8, 2, x86.R7, x86.R8, []byte{0x4E, 0x0F, 0xB7, 0x04, 0x07}},
		{x86.R8, 1, x86.R7, x86.R8, []byte{0x4E, 0x0F, 0xB6, 0x04, 0x07}},
		{x86.R7, 2, x86.R8, x86.R7, []byte{0x49, 0x0F, 0xB7, 0x3C, 0x38}},
		{x86.R7, 1, x86.R8, x86.R7, []byte{0x49, 0x0F, 0xB6, 0x3C, 0x38}},
		{x86.R6, 2, x86.R9, x86.R6, []byte{0x49, 0x0F, 0xB7, 0x34, 0x31}},
		{x86.R6, 1, x86.R9, x86.R6, []byte{0x49, 0x0F, 0xB6, 0x34, 0x31}},
		{x86.R5, 2, x86.R10, x86.R5, []byte{0x49, 0x0F, 0xB7, 0x2C, 0x2A}},
		{x86.R5, 1, x86.R10, x86.R5, []byte{0x49, 0x0F, 0xB6, 0x2C, 0x2A}},
		{x86.SP, 2, x86.R11, x86.SP, []byte{0x4A, 0x0F, 0xB7, 0x24, 0x1C}},
		{x86.SP, 1, x86.R11, x86.SP, []byte{0x4A, 0x0F, 0xB6, 0x24, 0x1C}},
		{x86.R3, 2, x86.R12, x86.R3, []byte{0x49, 0x0F, 0xB7, 0x1C, 0x1C}},
		{x86.R3, 1, x86.R12, x86.R3, []byte{0x49, 0x0F, 0xB6, 0x1C, 0x1C}},
		{x86.R2, 2, x86.R13, x86.R2, []byte{0x49, 0x0F, 0xB7, 0x54, 0x15, 0x00}},
		{x86.R2, 1, x86.R13, x86.R2, []byte{0x49, 0x0F, 0xB6, 0x54, 0x15, 0x00}},
		{x86.R1, 2, x86.R14, x86.R1, []byte{0x49, 0x0F, 0xB7, 0x0C, 0x0E}},
		{x86.R1, 1, x86.R14, x86.R1, []byte{0x49, 0x0F, 0xB6, 0x0C, 0x0E}},
		{x86.R0, 2, x86.R15, x86.R0, []byte{0x49, 0x0F, 0xB7, 0x04, 0x07}},
		{x86.R0, 1, x86.R15, x86.R0, []byte{0x49, 0x0F, 0xB6, 0x04, 0x07}},
	}

	for _, pattern := range usagePatterns {
		t.Logf("loadzx %dB %s, [%s+%s]", pattern.Length, pattern.Destination, pattern.Base, pattern.OffsetRegister)
		code := x86.LoadDynamicRegisterZeroExtend(nil, pattern.Destination, pattern.Base, pattern.OffsetRegister, pattern.Length)
		assert.DeepEqual(t, code, pattern.Code)
	}
}