...
// StoreDynamicRegister writes the contents of the register to a memory address with a register offset.
...
// StoreRegister writes the contents of the register to a memory address with a signed offset from -256 to 255.
